...
import { Wand2, Copy, Check, Code, Users, Image as ImageIcon } from 'lucide-react'
...
- Seu nicho de atuação: ${formData.niche}.
...
Sua primeira tarefa: Crie 3 ganchos (Hooks) virais para um vídeo de 30 segundos vendendo este produto.`
      ...
      addToast('Prompts gerados com sucesso!', 'success')
    }, 800)
  }
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <div className="space-y-6">
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <Input
                label="Qual produto você vai vender?"
          ...
          >
            {isGenerating ? (
              ...
              <><Wand2 className="w-5 h-5 mr-2" /> Gerar Mega Prompts de Persona</>
            )}
          </Button>
        </div>
        ...
        <div className="space-y-6">
          ...
          <Card className="flex flex-col flex-1">
            ...
            <CardContent>
              {generatedChatPrompt ? (
                <div className="bg-panelHover rounded-lg border border-border p-3 overflow-auto h-72">
                  <pre className="text-xs text-textSecondary whitespace-pre-wrap font-mono">
                    {generatedChatPrompt}
                  </pre>
                </div>
              ) : (
                <div className="h-72 flex items-center justify-center text-textSecondary text-sm border border-dashed border-border rounded-lg bg-background/50">
                  Aguardando geração...
                </div>
              )}
            </CardContent>
