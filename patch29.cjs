...
const oldHeader = `<div className="w-full flex justify-between items-center mb-4">
...
const newHeader = `<div className="w-full flex flex-col md:flex-row justify-between items-center mb-4 gap-4">
...
sb = sb.replace(oldHeader, newHeader);
